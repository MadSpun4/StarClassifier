...
class LauncherFrame(tk.Frame):
    ...
    def _build(self):
        ...
        for text, command, bg in [
            ...
            ('Сбросить базу знаний к значениям по умолчанию', self.reset_knowledge_base, COLORS['gray_btn']),
        ]:
            tk.Button(
                buttons,
                text=text,
    ...
    def reset_knowledge_base(self):
        ...
        self.refresh_status()
        info(self, 'База знаний восстановлена', 'Значения базы знаний снова соответствуют значениям по умолчанию.')
